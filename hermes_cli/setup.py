...
_DEFAULT_PROVIDER_MODELS = {
    ...
    "ai-gateway": ["anthropic/claude-opus-4.6", "anthropic/claude-sonnet-5", "openai/gpt-5", "google/gemini-3-flash"],
    "kilocode": ["anthropic/claude-opus-4.6", "anthropic/claude-sonnet-5", "openai/gpt-5.4", "google/gemini-3-pro-preview", "google/gemini-3-flash-preview"],
    "opencode-zen": ["gpt-5.4", "gpt-5.3-codex", "claude-sonnet-5", "gemini-3-flash", "glm-5", "kimi-k2.5", "minimax-m2.7"],
