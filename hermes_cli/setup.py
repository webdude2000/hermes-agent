...
_DEFAULT_PROVIDER_MODELS = {
    ...
    "ai-gateway": ["anthropic/claude-opus-4.8", "anthropic/claude-sonnet-5", "openai/gpt-5", "google/gemini-3-flash"],
    "kilocode": ["anthropic/claude-opus-4.8", "anthropic/claude-sonnet-5", "openai/gpt-5.4", "google/gemini-3-pro-preview", "google/gemini-3-flash-preview"],
