...
class AIAgent:
    ...
    def __init__(
        ...
        Args:
            ...
            model (str): Model name to use (default: "anthropic/claude-opus-4.8")
...
def main(
    ...
    Args:
        ...
        model (str): Model name to use (OpenRouter format: provider/model). Defaults to anthropic/claude-sonnet-5.
